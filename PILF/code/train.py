...
def parse_args():
    ...
    parser.add_argument('--trainset_dir', type=str, default='/home/vision/work/mjh/dataset/RE_HCI/train_2x2_sx1SR_7x7/')
    parser.add_argument('--testset_dir', type=str, default='/home/vision/work/mjh/dataset/RE_HCI/test_2x2_sx1SR_7x7/')
    ...
    parser.add_argument('--model_path', type=str, default='../save/checkpoint_GILF_ASR_zh_lr1_RE_HCI_2_7/GILF_ASR_1xSR_2x2_epoch_1.pth.tar')

    parser.add_argument('--tag', type=str, default='GILF_ASR_lr1_RE_HCI')##
...
def train(cfg, train_loader, test_Names, test_loaders):
    ...
    net = Net_CrossAttention(cfg.angin,cfg.angout)
    ...
    for idx_epoch in range(epoch_state, cfg.n_epochs):
        ...
        if idx_epoch % 1 == 0:
            ...
            save_ckpt({
                ...
                'state_dict': net.state_dict(),  # for torch.nn.DataParallel
                'loss': loss_list,},
                save_path=savepath, filename=cfg.model_name + '_' + str(cfg.upscale_factor) + 'xSR_' + str(cfg.angout) +
...
def valid(test_loader, net):
    ...
    for idx_iter, (data, label) in (enumerate(test_loader)):
        ...
        psnr, ssim = cal_metrics_RE(label, outLF, cfg.angin, cfg.angout)
